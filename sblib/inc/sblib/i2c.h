...
typedef enum {
  ...
  I2C_STATUS_ARBLOST,	/**< Arbitration lost during transfer */
 ...
 * @param	len			: Number of bytes to be transferred from @a buff
 * @return	Number of bytes successfully   return len - xfer.txSz;
transferred
 */
...
/**
 * @brief	Transfer data to slave and receive data from slave after a repeated start
 * @param	id			: I2C peripheral ID (I2C0, I2C1 ... etc)
 * @param	slaveAddr	: Slave address of the I2C device
 * @param	cmd			: Pointer to memory that will hold the data to be written
 * @param	buff		: Pointer to memory that will hold the data received
