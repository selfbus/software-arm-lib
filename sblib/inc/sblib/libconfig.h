...
#   define SERIAL_RX_PIN PIO1_6 //!< on a 4TE-ARM Controller pin 1 on connector SV3 (ID_SEL)
#   define SERIAL_TX_PIN PIO1_7 //!< on a 4TE-ARM Controller pin 2 on connector SV3 (ID_SEL)
#endif
