 ...
 * setup() function.
 */
class BcuDefault: public BcuBase, public BusVoltage
{
public:
    ...
    AppUserSaveCallback * ptr_appusersaveCallback = (nullptr);
    ...
    /**
     * Set a callback class to notify the user program of bus voltage failure
     * save the APP/user application environment in case of bus voltage failure
     *
     */
    void setAppUserSaveCallback(AppUserSaveCallback *callback);
