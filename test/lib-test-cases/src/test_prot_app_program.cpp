...
static Telegram testCaseTelegrams[] =
{
    ...
    // 1. T_CONNECT 0.0.1->1.1.18
    {TEL_RX,  7, 0, connect             , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x60, 0x80}},
    // 2. DeviceDescriptorRead (MaskVersion)
    {TEL_RX,  8, 2, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x61, 0x43, 0x00}},
    // 3. T_ACK 1.1.18->0.0.1
    {TEL_TX,  7, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x60, 0xC2}},
    // 4. bcu.loop()
    {LOOP,  1, 0, NULL                  , {}},
    // 5.DeviceDescriptorResponse 1.1.18->0.0.1
    {TEL_TX, 10, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x63, 0x43, 0x40, MASK_VERSION_HIGH, MASK_VERSION_LOW}},
    // 6. T_ACK 0.0.1->1.1.18
    {TEL_RX,  7, 0, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x60, 0xC2}},
    // 7. APCI_MEMORY_READ_PDU count=1 address=0x104
    {TEL_RX, 10, 2, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x63, 0x46, 0x01, 0x01, 0x04}},
    // 8. T_ACK 1.1.18->0.0.1
    {TEL_TX,  7, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x60, 0xC6}},
    // 9. bcu.loop()
    {LOOP,  1, 0, NULL                  , {}},
    // 10.
    {TEL_TX, 11, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x64, 0x46, 0x41, 0x01, 0x04, 0x04}},
    // 11. T_ACK 0.0.1->1.1.18
    {TEL_RX,  7, 0, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x60, 0xC6}},
    // 12. APCI_MEMORY_READ_PDU count=1 address=0x10C
    {TEL_RX, 10, 2, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x63, 0x4A, 0x01, 0x01, 0x0C}},
    // 13.
    {TEL_TX,  7, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x60, 0xCA}},
    // 14.
    {LOOP,  1, 0, NULL                  , {}},
    // 15.
    {TEL_TX, 11, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x64, 0x4A, 0x41, 0x01, 0x0C, 0x00}},
    {TEL_RX,  7, 0, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x60, 0xCA}},
    {TEL_RX,  7, 0, disconnect          , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x60, 0x81}},
    {TEL_RX,  7, 0, connect             , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x60, 0x80}},
    // 19. DeviceDescriptorRead (MaskVersion)
    {TEL_RX,  8, 2, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x61, 0x43, 0x00}},
    // 20.
    {TEL_TX,  7, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x60, 0xC2}},
    {LOOP,  1, 0, NULL                  , {}},
    // 22. DeviceDescriptorResponse 1.1.18->0.0.1 Mask=0x0012
    {TEL_TX, 10, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x63, 0x43, 0x40, MASK_VERSION_HIGH, MASK_VERSION_LOW}},
    {TEL_RX,  7, 0, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x60, 0xC2}},
    // 24. APCI_MEMORY_WRITE_PDU count=1 address=0x10D
    {TEL_RX, 11, 1, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x64, 0x46, 0x81, 0x01, 0x0D, 0x00}},
    // 25.
    {TEL_TX,  7, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x60, 0xC6}},
    {LOOP,  1, 0, NULL                  , {}},
    // 27. APCI_MEMORY_READ_PDU count=1 address=0x10D
    {TEL_RX, 10, 2, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x63, 0x4A, 0x01, 0x01, 0x0D}},
    {TEL_TX,  7, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x60, 0xCA}},
    {LOOP,  1, 0, NULL                  , {}},
    // 30. APCI_MEMORY_RESPONSE_PDU count=1 address=0x10D
    {TEL_TX, 11, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x64, 0x46, 0x41, 0x01, 0x0D, 0x00}},
    {TEL_RX,  7, 0, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x60, 0xC6}},
    // 32. APCI_MEMORY_WRITE_PDU count=1 address=0x116
    {TEL_RX, 11, 1, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x64, 0x4E, 0x81, 0x01, 0x16, 0x01}},
    {TEL_TX,  7, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x60, 0xCE}},
    // 34. APCI_MEMORY_READ_PDU count=1 address=0x116
    {TEL_RX, 10, 2, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x63, 0x52, 0x01, 0x01, 0x16}},
    {TEL_TX,  7, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x60, 0xD2}},
    {LOOP,  1, 0, NULL                  , {}},
    // 37. APCI_MEMORY_RESPONSE_PDU count=1 address=0x116
    {TEL_TX, 11, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x64, 0x4A, 0x41, 0x01, 0x16, 0x01}},
    {TEL_RX,  7, 0, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x60, 0xCA}},
    // 38. APCI_MEMORY_READ_PDU count=1 address=0x100
    {TEL_RX, 10, 2, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x63, 0x56, 0x01, 0x01, 0x00}},
    // 40.
    {TEL_TX,  7, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x60, 0xD6}},
    {LOOP,  1, 0, NULL                  , {}},
    // 38. APCI_MEMORY_RESPONSE_PDU count=1 address=0x100
    {TEL_TX, 11, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x64, 0x4E, 0x41, 0x01, 0x00, 0xFF}},
    {TEL_RX,  7, 0, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x60, 0xCE}},
    // 47. APCI_MEMORY_READ_PDU count=9 address=0x104
    {TEL_RX, 10, 2, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x63, 0x5A, 0x09, 0x01, 0x04}},
    // 45.
    {TEL_TX,  7, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x60, 0xDA}},
    {LOOP,  1, 0, NULL                  , {}},
    {TEL_TX, 19, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x6C, 0x52, 0x49, 0x01, 0x04, 0x04, 0x20, 0x60, 0x01, 0xFF, 0x00, 0x00, 0x00, 0x00}},
    {TEL_RX,  7, 0, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x60, 0xD2}},
    {TEL_RX, 13, 1, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x66, 0x5E, 0x83, 0x01, 0x08, 0xFE, 0x11, 0x40}},
    // 50.
    {TEL_TX,  7, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x60, 0xDE}},
    {TEL_RX, 10, 2, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x63, 0x62, 0x03, 0x01, 0x08}},
    {TEL_TX,  7, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x60, 0xE2}},
    {LOOP,  1, 0, NULL                  , {}},
    {TEL_TX, 13, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x66, 0x56, 0x43, 0x01, 0x08, 0xFE, 0x11, 0x40}},
    // 55.
    {TEL_RX,  7, 0, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x60, 0xD6}},
    {TEL_RX, 10, 2, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x63, 0x66, 0x08, 0x01, 0x0E}},
    {TEL_TX,  7, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x60, 0xE6}},
    {LOOP,  1, 0, NULL                  , {}},
    {TEL_TX, 18, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x6B, 0x5A, 0x48, 0x01, 0x0E, 0x60, 0x63, 0xEF, 0x41, 0x9A, 0x00, 0x00, 0x00}},
    {TEL_RX,  7, 0, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x60, 0xDA}},
    // 60.
    {TEL_RX, 11, 1, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x64, 0x6A, 0x81, 0x01, 0x0E, 0xE0}},
    {TEL_TX,  7, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x60, 0xEA}},
    {TEL_RX, 10, 2, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x63, 0x6E, 0x01, 0x01, 0x0E}},
    {TEL_TX,  7, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x60, 0xEE}},
    {LOOP,  1, 0, NULL                  , {}},
    {TEL_TX, 11, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x64, 0x5E, 0x41, 0x01, 0x0E, 0xE0}},
    {TEL_RX,  7, 0, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x60, 0xDE}},
    {TEL_RX, 12, 1, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x65, 0x72, 0x82, 0x01, 0x10, 0xA7, 0x19}},
    {TEL_TX,  7, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x60, 0xF2}},
    {TEL_RX, 10, 2, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x63, 0x76, 0x02, 0x01, 0x10}},
    {TEL_TX,  7, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x60, 0xF6}},
    {LOOP,  1, 0, NULL                  , {}},
    {TEL_TX, 12, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x65, 0x62, 0x42, 0x01, 0x10, 0xA7, 0x19}},
    {TEL_RX,  7, 0, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x60, 0xE2}},
    {TEL_RX, 10, 2, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x63, 0x7A, 0x0C, 0x01, 0x19}},
    {TEL_TX,  7, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x60, 0xFA}},
    {LOOP,  1, 0, NULL                  , {}},
    {TEL_TX, 22, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x6F, 0x66, 0x4C, 0x01, 0x19, 0x10, 0x00, 0x10, 0x01, 0x10, 0x02, 0x10, 0x03, 0x10, 0x04, 0x10, 0x05}},
    {TEL_RX,  7, 0, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x60, 0xE6}},
    {TEL_RX, 10, 2, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x63, 0x7E, 0x0C, 0x01, 0x25}},
    {TEL_TX,  7, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x60, 0xFE}},
    {LOOP,  1, 0, NULL                  , {}},
    {TEL_TX, 22, 0, NULL                , {0xB0, 0x11, 0x12, 0x00, 0x01, 0x6F, 0x6A, 0x4C, 0x01, 0x25, 0x10, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
    {TEL_RX,  7, 0, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x60, 0xEA}},
    {TEL_RX, 10, 2, NULL                , {0xB0, 0x00, 0x01, 0x11, 0x12, 0x63, 0x42, 0x0C, 0x01, 0x31}},
