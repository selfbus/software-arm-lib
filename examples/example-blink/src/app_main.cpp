...
void setup()
{
    ...
    pinMode(PIN_INFO, OUTPUT); // PIO2.6 on the 4TE-ARM controller
    pinMode(PIN_RUN, OUTPUT);  // PIO3.3 on the 4TE-ARM controller
}
...
void loop_noapp()
{
    ...
    // toggle output PIO3.3 for the Selfbus 4TE-ARM-Controller RUN-LED
