 ...
 * @defgroup SBLIB_EXAMPLE_I2C_SHT2X i2c SHT2x temperature and humidity sensor example
 * @ingroup SBLIB_EXAMPLES
 * @brief   Read SHT2x temperature and humidity sensor
 *
...
BcuBase* setup()
{
    ...
    serial.begin(115200);
    serial.println("Selfbus I2C SHT2x sensor example");
    SHT21.Init();
...
void ReadSHTTemp() {
	...
	serial.println("SHT2x Temp: ", temp);
}
